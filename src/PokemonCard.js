...
function PokemonCard(props) {
  ...
  return (
		<div className="card" id={pokemon.name} style={{ animation: animation, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: 'lightblue' }}> {/* might change the color here */}
